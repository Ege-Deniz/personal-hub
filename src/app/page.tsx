...
import SelectedSystems from "@/components/ui/SelectedSystems";
          ...
          <div className="relative z-10">
            ...
            <BentoGrid>
              ...
              <GlassCard className="card-hero" delay={0}>
                ...
                {/* ═══ ROW 5: Spotify (2col) + Twitch + Steam — restyled clean ═══ */}
                ...
                <GlassCard className="card-twitch" delay={0.5}>
                  <div className="p-5 h-full flex flex-col justify-center items-center text-center">
                    <svg
                      ...
                      className="w-9 h-9 text-white/70 mb-4"
                    >
                      <path d="M21 2H3v16h5v4l4-4h5l4-4V2zm-10 9V7m5 4V7" />
                    </svg>
                    <div className="font-display text-[1.05rem] font-bold mb-1 text-white/90">
                      Twitch
                    </div>
                    <p className="text-[0.72rem] text-white/30 mb-4 leading-[1.5]">
                      Coding sessions and competitive FPS.
                    </p>
                    <a
                      href="https://www.twitch.tv/Rowy"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="font-mono text-[0.58rem] uppercase tracking-[1.5px] py-2 px-5 rounded-md border border-white/10 text-white/40 hover:border-cyan/40 hover:text-cyan transition-all"
                    >
                      Visit Channel
                    </a>
                  </div>
