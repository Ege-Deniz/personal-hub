...
function LiveHUD() {
  ...
  return (
    <motion.div
      ...
      transition={{ delay: reduced ? 0.1 : 3.85, duration: 0.9, ease: [0.16, 1, 0.3, 1] }}
...
export default function Hero() {
  // Reduced motion: the boot overlay clears in 0.4s, so the reveal delays
  // collapse too — no staring at an empty field.
  const reduced = useReducedMotion();
  const d = (t: number) => (reduced ? 0.1 : t);
  return (
    <section
      id="hero"
    ...
    >
      ...
      <div className="relative z-10 w-full flex flex-col items-start">
        ...
        <motion.div
          ...
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: d(4.1), duration: 0.6 }}
        >
